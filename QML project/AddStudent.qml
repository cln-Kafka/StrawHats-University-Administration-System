        ...
        Image {
            ...
            Rectangle {
                ...
                TextField {
                    ...
                    horizontalAlignment: Text.AlignLeft
                    font.pointSize: 20
                    placeholderText: qsTr("Average Grade")
                    anchors.bottomMargin: 14
                    placeholderTextColor: "white"
                    color: "white"
                    font.family: "Dk Crayon Crumble"
            ...
            Component {
                ...
                Row {
                    ...
                    TextField {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        font.pointSize: 20
                        placeholderText: "Course" /*qsTr(model.name)*/
                        placeholderTextColor: "black"
                        color: "black"
                        font.family: "Dk Crayon Crumble"

                        background: Rectangle {
                            id: rectangleTitleClassBorder
                            width: parent.width
                            height: 1
                            color: "#cecece"
                            anchors.bottom: parent.bottom
                    ...
                    TextField {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        font.pointSize: 20
                        placeholderText: "Grade" /*qsTr(model.grade)*/
                        placeholderTextColor: "black"
                        color: "black"
                        font.family: "Dk Crayon Crumble"

                        background: Rectangle {
                            id: rectangleTitleGradeBorder
                            width: parent.width
                            height: 1
                            color: "#cecece"
                            anchors.bottom: parent.bottom

...
Page{
    ...
    Item {
        ...
        Image {
            ...
            Rectangle {
                ...
                Text {
                    id: textExportStudents
                    text: qsTr("Export students data")
                    anchors.fill: parent
                    horizontalAlignment: Text.AlignHCenter
                    font.pointSize: 24
                    color: "white"
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        onEntered: {textExportStudents.underlined = true}
                        onExited: {textExportStudents.underlined = false}
                    }
                }
            }
        }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            anchors.topMargin: 84
                ...
                Component {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            anchors.topMargin: 5
                            MouseArea {
                                id: mouseAreaOneStudent
                                anchors.fill: parent
                                onClicked: {stackView.push(studentPage)}
                                hoverEnabled: true
                                onEntered: {textStudent.underlined = true}
                                onExited: {textStudent.underlined = false}
                            }
                        }
                    }
                }
                ...
                ListModel {
                    id: nameModel
                    ListElement {name: "Student 01"}
                    ListElement {name: "Student 02"}
                }
    ...
    TextField {
        id: textFieldAllStudents
        anchors.left: itemOfImageBoard.right
        anchors.right: parent.right
        anchors.top: parent.top
        anchors.bottom: rectangleOfStudentsTable.top
        anchors.rightMargin: 40
        anchors.leftMargin: 40
        ...
        font.bold: true
        font.pointSize: 25
        placeholderText: qsTr("Search for a Student")
